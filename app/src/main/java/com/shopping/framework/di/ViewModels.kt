...
import com.shopping.presentation.shopitem.insert.ShopItemInsertActivityViewModel
...
val viewModelModule = module {
    ...
    viewModel { ShopItemShowFragmentViewModel(get(), get(), get()) }
    viewModel { ShopItemInsertActivityViewModel(get(), get(), get()) }
}